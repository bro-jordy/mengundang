...
import { RevealSection, StaggerWrap, StaggerItem } from "./JackpotAnimations";
...
export function JackpotEventSection({ events, showMap, lang = "ID" }: Props) {
      ...
      <div className="max-w-lg mx-auto text-center">
        ...
        <div className="space-y-6 mt-10">
          {events.map((event, index) => (
            <RevealSection key={event.id} delay={0.1 * index}>
